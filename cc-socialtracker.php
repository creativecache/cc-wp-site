<?php 
/* Template Name: Creative Cache Social Tracker */ 
 ?>
...
<head>
	...
	<meta name="description" content="The Creative Cache Social Tracker keeps track of the follower counts for you business' Instagram, Twitter and Facebook Pages." />

	<!-- CSS Styles -->
	<link href="https://fonts.googleapis.com/css?family=Montserrat|Open+Sans" rel="stylesheet">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" />
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" integrity="sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb" crossorigin="anonymous">
	<link rel="stylesheet" type="text/css" href="<?php echo get_bloginfo('stylesheet_directory'); ?>/socialtracker/css/styles.css" />

	<!-- Scripts -->
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	<script src="<?php echo get_bloginfo('stylesheet_directory'); ?>/socialtracker/js/jquery.cookie.js"></script>
	<script src="<?php echo get_bloginfo('stylesheet_directory'); ?>/socialtracker/js/custom.js"></script>
</head>
<body>
	<?php
		error_reporting(0);
